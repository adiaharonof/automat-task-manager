...
class TaskManager:
    ...
    def create_task(self, task: Task) -> Task:
        """ Giving a task an ID, adding it to the tasks dict and Increments the ID counter by one"""
    ...
    def get_completed_tasks(self) -> List:
        """ return the completed tasks as a list"""
        completed_tasks = []
    ...
    def get_uncompleted_tasks(self) -> List:
        """ return the uncompleted tasks as a list"""
        uncompleted_tasks = []
        for task in self.tasks.values():
            if not task.done:
    ...
    def get_overdue_tasks(self) -> List:
        """ checks if a task isn't done,if she has a deadline and her deadline has passed
